...
namespace InventoryTools.Ui
{
    public class ConfigurationWindow : GenericWindow, IMenuWindow
    {
        ...
        public override void Initialize()
        {
            ...
            _configPages.Add(new SeparatorPageItem("Settings".Tr()));
            ...
            _configPages.Add(new SeparatorPageItem("Modules".Tr(), true));
            ...
            _configPages.Add(new SeparatorPageItem("Data".Tr(), true));
            ...
            _settingsMenu = new PopupMenu("configMenu", PopupMenu.PopupMenuButtons.All,
                new List<PopupMenu.IPopupMenuItem>()
                {
                    new PopupMenu.PopupMenuItemSelectable("Items Window".Tr(), "filters", OpenFiltersWindow,"Open the items window.".Tr()),
                    new PopupMenu.PopupMenuItemSelectable("Craft Window".Tr(), "crafts", OpenCraftsWindow,"Open the crafts window.".Tr()),
            ...
            _wizardMenu = new PopupMenu("wizardMenu", PopupMenu.PopupMenuButtons.All,
                new List<PopupMenu.IPopupMenuItem>()
                {
                    new PopupMenu.PopupMenuItemSelectable("Configure new settings".Tr(), "configureNew", ConfigureNewSettings,"Configure new settings.".Tr()),
                    new PopupMenu.PopupMenuItemSelectable("Configure all settings".Tr(), "configureAll", ConfigureAllSettings,"Configure all settings.".Tr()),
                });
        ...
        private void DrawSearchBar()
        {
            ...
            ImGui.InputTextWithHint("##configSearch", "Search settings...".Tr(), ref _searchQuery, 100);

            if (!string.IsNullOrWhiteSpace(_searchQuery))
            {
                ImGui.SameLine();
                if (ImGui.Button("Clear".Tr() + "##configSearchClear"))
                {
        ...
        private void DrawSearchResults()
        {
            ...
            if (results.Count == 0)
            {
                ImGui.TextWrapped($"{"No settings match".Tr()} '{_searchQuery}'.");
                return;
            }
