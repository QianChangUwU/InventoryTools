...
public static class LocalizationService
{
    ...
    private static Dictionary<string, string> BuildTranslations()
    {
        ...
        d["Introduction"] = "功能介绍";
        d["Set up"] = "设置";
        d["You can also go back through the introduction covering what the plugin does."] = "你也可以重新查看插件功能介绍。";
        d["Show me around again"] = "重新查看介绍";
        d["This will guide you through what the plugin does and then help you set up the most commonly used features. It takes a couple of minutes, and everything here can be changed later in the settings window."] = "本向导会介绍插件的功能，并帮助你设置最常用的功能。整个过程只需几分钟，之后也可以在设置窗口中随时修改。";
        d["If you are a returning user, feel free to close this window."] = "如果你已经使用过本插件，可以直接关闭此窗口。";
        d["Show this wizard when new features are released"] = "发布新功能时显示此向导";
        d["Search settings..."] = "搜索设置……";
        d["Clear"] = "清除";
        d["Modules"] = "模块";
        d["Data"] = "数据";
        d["Items Window"] = "物品窗口";
        d["Craft Window"] = "制作窗口";
        d["Open the crafts window."] = "打开制作窗口。";
        d["Configure new settings"] = "配置新设置";
        d["Configure new settings."] = "配置新设置。";
        d["Configure all settings"] = "配置全部设置";
        d["Configure all settings."] = "配置全部设置。";
        d["No settings match"] = "没有匹配的设置";
        d["About"] = "关于";
        d["Overview"] = "概览";
        d["Defaults"] = "默认设置";
        d["Appearance"] = "外观";
        ...
        d["List Basics"] = "列表基础";
        d["Filtering"] = "筛选";
        d["Advanced search syntax"] = "高级搜索语法";
        d["Windows & Lists"] = "窗口与列表";
        d["Troubleshooting"] = "故障排查";
        d["Equipment Recommendation"] = "装备推荐";
        d["Equipment recommendations"] = "装备推荐";
        d["Market Board"] = "市场布告板";
        d["Market prices"] = "市场价格";
        d["Context Menu"] = "右键菜单";
        d["Craft Overlay"] = "制作悬浮窗";
        d["Craft planning"] = "制作规划";
        d["Inventory tracking"] = "库存追踪";
        d["Item information"] = "物品信息";
        d["Item locations"] = "物品位置";
        d["Item unlock status"] = "物品解锁状态";
        d["Ingredient patch"] = "素材版本";
        d["Source information"] = "来源信息";
        d["Use information"] = "用途信息";
        d["Outfit glamour"] = "套装投影";
        d["Coffer loot"] = "宝箱内容";
        d["Curated lists"] = "精选列表";
        d["Amount to retrieve"] = "待取出数量";
        d["Acquisition tracker"] = "获取追踪器";
        d["Active lists"] = "活动列表";
        d["Saving"] = "保存";
        d["Integrations"] = "集成";
        d["Downloading"] = "下载";
        d["Worlds to price"] = "价格服务器";
        d["Toggle a window"] = "切换窗口";
        d["While hovering an item"] = "悬停物品时";
        d["When to highlight"] = "何时高亮";
        d["Colours"] = "颜色";
        d["Destinations"] = "目标位置";
        d["Retainer list"] = "雇员列表";
        d["Shop highlighting"] = "商店高亮";
        d["Tracking"] = "追踪";
        d["Three kinds"] = "三种列表";
        d["Two things worth knowing"] = "需要了解的两件事";
        d["What you get"] = "可以获得什么";
        d["What's in it"] = "包含内容";
        d["Have a look"] = "查看一下";
        d["If something is missing"] = "如果内容缺失";
        d["After that"] = "完成之后";
        d["Look things up"] = "查询内容";
        d["Plan your crafts"] = "规划制作";
        d["Track your inventories"] = "追踪库存";
        d["Your items"] = "你的物品";
        d["Open in game"] = "在游戏中打开";
        d["Example uses:"] = "使用示例：";
        d["Save automatically"] = "自动保存";
        d["How often"] = "保存间隔";
        d["Add a button to the title menu"] = "在标题菜单中添加按钮";
        d["List compendium windows in Wotsit"] = "在 Wotsit 中列出图鉴窗口";
        d["Download prices automatically"] = "自动下载价格";
        d["Keep prices for (hours)"] = "价格保留时间（小时）";
        d["Sale history window (days)"] = "成交历史范围（天）";
        d["Current world"] = "当前服务器";
        d["Home world"] = "主服务器";
        d["Additional worlds"] = "其他服务器";
        d["Track inventory changes"] = "记录库存变化";
        d["Events worth recording"] = "需要记录的事件";
        d["Wait this long after login before scanning"] = "登录后等待此时间再扫描";
        d["Keep tracking this long after you stop"] = "停止操作后继续追踪此时间";
        d["Control how various windows are laid out."] = "控制各个窗口的布局方式。";
        d["Windows that should stay open when you press escape."] = "按下 Esc 时仍保持打开的窗口。";
        d["Ignore escape"] = "忽略 Esc";
        d["Stay open across reloads"] = "重载后保持打开";
        d["Recommend by"] = "推荐依据";
        d["Compendium row height"] = "图鉴行高";
        d["Items shown when expanded"] = "展开时显示的物品数";
        d["Hide during duties and cutscenes"] = "任务和过场动画中隐藏";
        d["Remember the choice between sessions"] = "在不同会话间记住选择";
        d["Matched item colour"] = "匹配物品颜色";
        d["Matching tab colour"] = "匹配标签颜色";
        d["Destination colour"] = "目标位置颜色";
        d["Colour retainer names"] = "为雇员名称着色";
        d["Name colour"] = "名称颜色";
        d["Show item counts"] = "显示物品数量";
        d["Dim items that don't match"] = "淡化不匹配的物品";
        d["Highlight vendor NPCs in the world"] = "在世界中高亮商店 NPC";
        d["Show an icon on their nameplate"] = "在其姓名板上显示图标";
        d["Default text colour"] = "默认文本颜色";
        d["Blank lines above"] = "上方空行";
        d["Blank lines below"] = "下方空行";
        d["Enable tooltip tweaks"] = "启用悬浮提示增强";
        d["Show in Allagan Tools' own windows"] = "在 Allagan Tools 自身窗口中显示";
        d["Label added lines with the plugin name"] = "用插件名称标记新增内容";
        d["Limit to these item categories"] = "仅限这些物品分类";
        d["Treat the list above as exclusions"] = "将上方列表视为排除项";
        d["Show where I own this"] = "显示持有位置";
        d["Search these locations"] = "搜索这些位置";
        d["Display mode"] = "显示模式";
        d["Maximum results"] = "最大结果数";
        d["Current character only"] = "仅当前角色";
        d["Affix the character name"] = "附加角色名称";
        d["Show amount to retrieve"] = "显示待取出数量";
        d["Show average NQ/HQ price"] = "显示平均 NQ/HQ 价格";
        d["Show minimum NQ/HQ price"] = "显示最低 NQ/HQ 价格";
        d["Show unlock status"] = "显示解锁状态";
        d["Characters to check"] = "要检查的角色";
        d["Hide characters who have it"] = "隐藏已拥有的角色";
        d["Show coffer contents"] = "显示宝箱内容";
        d["Show curated lists"] = "显示精选列表";
        d["Limit to these lists"] = "仅限这些列表";
        d["Match item quality"] = "匹配物品品质";
        d["Text colour"] = "文本颜色";
        d["Show outfit glamour info"] = "显示套装投影信息";
        d["Acquired item colour"] = "已获得物品颜色";
        d["Not acquired item colour"] = "未获得物品颜色";
        d["Show ingredient patch"] = "显示素材版本";
        d["Show source information"] = "显示来源信息";
        d["Show use information"] = "显示用途信息";
        d["Hold this key to show"] = "按住此按键显示";
        d["Copy item name"] = "复制物品名称";
        d["More information"] = "更多信息";
        d["Search for this item"] = "搜索此物品";
        d["Add to craft list"] = "添加到制作列表";
        d["Add to the active craft list"] = "添加到当前制作列表";
        d["Add to curated list"] = "添加到精选列表";
        d["Add or remove from favourites"] = "添加或移出收藏";
        d["Crafting log"] = "制作笔记";
        d["Gathering log"] = "采集笔记";
        d["Fishing log"] = "钓鱼笔记";
        d["Whichever log applies"] = "打开适用的笔记";
        d["Report a bug"] = "报告问题";
        d["Open the wiki"] = "打开 Wiki";

        // ===== 15.0.12 精选列表悬浮提示 =====
        d["Curated Lists: "] = "精选列表：";
        d["Curated List Info"] = "精选列表信息";
        d["When hovering an item, show which of your curated lists already contain it."] = "悬停物品时，显示哪些精选列表已经包含该物品。";
        d["Curated Lists to Check"] = "要检查的精选列表";
        d["Which curated lists should be checked? If no lists are picked, every curated list is checked."] = "要检查哪些精选列表？如果未选择，则检查所有精选列表。";
        d["Match Item Quality"] = "匹配物品品质";
        d["Should the quality of the hovered item match the quality stored in the curated list? When off, a NQ item will match a HQ entry and vice versa."] = "悬停物品的品质是否必须与精选列表中保存的品质一致？关闭时，NQ 与 HQ 物品可以互相匹配。";
        d["lists selected"] = "个列表已选择";
